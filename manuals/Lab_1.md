...
### Установка ОС на ВМ
>[!NOTE]
>Операционная система (ОС) – комплекс программ, управляющий аппаратными и программными ресурсами компьютера (или ВМ) и предоставляющий пользователю и приложениям единый интерфейс для работы с файловой системой, процессами, устройствами и другими ресурсами.
